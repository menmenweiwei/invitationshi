...
<head>
<meta charset="UTF-8">
<base href="http://invitation.weismiley.com"></base>
...
<script>
var siteUrl = "http://invitation.weismiley.com";
$(function(){
//   for ( i = 1; i < 28; i++)
//   {
...
<div class="wrap" style="min-height:514px;">
    <div style="position: absolute;height: 356px;padding:0;text-align:center;" class="js_cover">
        ...
        <a href="http://invitation.weismiley.com/detail.php" style="z-index:10;display: block;width: 91px;margin: auto;">
            <img src="images/button.png" style="margin:3 auto;display:block;z-index:10;">
        </a>
    </div>
